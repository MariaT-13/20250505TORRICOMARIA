...
\sf\footnotesize\setlength\tabcolsep{4pt}
\centering
\begin{tabular}{>{\raggedright\arraybackslash}m{3.5cm} | >{\raggedright\arraybackslash}m{2.4cm} |  S[table-format=3.1] | >{\raggedright\arraybackslash}m{2.6cm} }
\toprule
...
\bottomrule
\end{tabular}
\caption{Universo de los libros considerados.}\label{cuadro1-5}
\end{table}
