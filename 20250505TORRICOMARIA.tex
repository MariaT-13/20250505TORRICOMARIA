...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=\textwidth]{./media/5fc4de8ed2896b444a05b77427e58702d4c3c68d.png}
	\caption{Gráfico 2: Distribución de las ediciones por años y editoriales.}\label{figura1-1}
\end{figure}
...
\sf\footnotesize\setlength\tabcolsep{4pt}
\centering
\begin{tabular}{>{\raggedright\arraybackslash}m{3.5cm} | >{\raggedright\arraybackslash}m{2.4cm} |  >{\raggedright\arraybackslash}m{6mm} | >{\raggedright\arraybackslash}m{2.6cm} }
\toprule
...
\bottomrule
\end{tabular}
\caption{Universo de los libros considerados.}\label{cuadro5}
\end{table}
